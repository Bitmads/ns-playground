...
import { fontAwesomeIcons } from '@ns-playground/xplat/nativescript/utils';
...
import {
  ...
  PlatformWindowToken,
} from '@ns-playground/xplat/core';
import { throwIfAlreadyLoaded } from '@ns-playground/xplat/utils';
...
export class NsPlaygroundCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: NsPlaygroundCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'NsPlaygroundCoreModule');
  }
}
